 ...
 * Бюджет: 500 000 ¥ на двоих (еда + транспорт + шопинг + неоплаченные входы).
...
const TRACKER = {
  ...
  dateFrom: "2026-09-09",
  dateTo: "2026-09-24",
  note: "Потолок 500 000 ¥ на двоих за 16 дней. Спокойный темп ≈ 18 000 ¥/день. Крупное (Kobe beef, Hard Off) — из запаса, решением вдвоём.",
