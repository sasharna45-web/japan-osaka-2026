 ...
 * ($2225 → ≈347–356k ¥ при ~156–160). Резерв $1000 долларами — отдельно.
...
const TRACKER = {
  ...
  totalUsd: 3225,
  reserveUsd: { min: 1000, max: 1000 },
  /** Потолок трекера ≈ $2225 × 160. */
  budgetYen: 356000,
  budgetYenMin: 347000,
  budgetYenMax: 356000,
  softDailyYen: 18000,
  ...
  dateFrom: "2026-09-09",
  dateTo: "2026-09-25",
  note: "Трекер считает уже обменянные йены. План: $3225 всего → $1000 резерв долларами → в йены сначала $2225 (≈347–356k ¥ при ~156–160). Спокойный темп ≈ 18 000 ¥/день. Крупное сверх плана / второй обмен — из резерва $1000.",
